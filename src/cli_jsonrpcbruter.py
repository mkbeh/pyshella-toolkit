...
peers_block = 'The number of peers that will be asynchronous in bruteforce process.'
epilog = """
-----------------------------------------------------
Usage example: [TO DO]
...
def cli():
    ...
    parser.add_argument('-pB', '--peers-block', metavar='NUM', type=int, default=1, help=peers_block)
    parser.add_argument('-b', '--brute-order', metavar='NUMS', type=list, default=['H', 'U', 'P'], help=peers_block)
